...
public class Withdrawal {
    ...
    public static class Request {
        ...
        public @NotNull(message = "출금액을 입력해주세요") @Min(value = 1L, message = "출금액을 1원 이상 입력해주세요") Long getAmount() {
            return this.amount;
        }
        ...
        public void setAmount(@NotNull(message = "출금액을 입력해주세요") @Min(value = 1L, message = "출금액을 1원 이상 입력해주세요") Long amount) {
            this.amount = amount;
        }
        ...
        public String toString() {
            return "Withdrawal.Request(accountNumber=" + this.getAccountNumber() + ", accountPassword=" + this.getAccountPassword() + ", amount=" + this.getAmount() + ")";
        }
    }
    ...
    public static class Response {
        ...
        public String toString() {
            return "Withdrawal.Response(account=" + this.getAccount() + ", transaction=" + this.getTransaction() + ")";
        }
        ...
        private static class AccountResponse {
            ...
            public String toString() {
                return "Withdrawal.Response.AccountResponse(number=" + this.getNumber() + ", balance=" + this.getBalance() + ", createdAt=" + this.getCreatedAt() + ", updatedAt=" + this.getUpdatedAt() + ")";
            }
        }
        ...
        private static class TransactionResponse {
            ...
            public String toString() {
                return "Withdrawal.Response.TransactionResponse(number=" + this.getNumber() + ", amount=" + this.getAmount() + ", type=" + this.getType() + ", tradedAt=" + this.getTradedAt() + ")";
            }
        }
    }
}
